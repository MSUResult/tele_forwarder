...
# Add your bot token``
TOKEN = "7788006811:AAG2eCBCVcnYnfZqCV4Ax8-JjCVjLnCMM2c"

# List of groups/channels to forward the messages to (either username or chat ID)
TARGET_GROUPS = [
     {"chat_id": -1002396319261, "topic_id": None},  # Group with no topic
    {"chat_id":  -1002342109272, "topic_id": None},  # Group with no topic
    {"chat_id": -1002326136230, "topic_id": None},  # Private Channel
    

]
# List of users whose messages will be forwarded (optional, relevant for groups)
ALLOWED_USERS = ["shiv4539"]
